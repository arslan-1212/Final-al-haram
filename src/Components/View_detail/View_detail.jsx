...
function View_detail() {
  return (
    <div className=' mt-5'>
      <div className="text-capitalize   text-start  ms-md-5 capstan-lef  special_moblie "><h3 className='veiwn_del_main_moblie_heading'>al - hukair land monument park </h3></div>
<div className='capstan-lef2 text-capitalize text-start ms-1 ms-md-5 py-2 px-2'> <TbMap2 className='me-1 fs-3'/> 

28800 Orchard Lake Road, Suite 180 Farmington Hills, U.S.A</div> 
      <div className="row px-3 m-0">
        <div className="col-lg-8 col-md-6 col-sm-12">
        <div className='mt-3'>
        <Slidercor sliderlan1="Al-Hokairland-00-ingresso-foto1 1.png" sliderlan2="Al-Hokairland-00-ingresso-foto1 1.png" sliderlan3="Al-Hokairland-00-ingresso-foto1 1.png"/>
       </div>
        </div>
...
Naka, Wagle Estate, Thane West,Thane
      ...
      <div className='flight_main'>
        <div className=" veiw_del_main_card">
        

        <div className="swipppr veiwn_del_slider_here">
   

        <div className="secondly veiw_deltails_slider_mt">
