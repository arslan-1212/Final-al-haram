...
import Tab_zayad from '../Tab_zayad/Tab_zayad';
import Similar from '../Similar/Similar';
function View_details_zayad_mosq() {
  return (
    <div className=' mt-5 pt-md-5'>
<div className="text-capitalize   text-start ms-1 ms-md-5 capstan-lef">sheikh zayed mosque</div>
...
28800 Orchard Lake Road, Suite 180 Farmington Hills, U.S.A</div> 
      ...
      <div className="row px-3 m-0">
        ...
        <div className='mt-3'>
        <Slidercor sliderlan1="terrence-low-ZADioNn1XKw-unsplash 1.png" sliderlan2="terrence-low-ZADioNn1XKw-unsplash 1.png" sliderlan3="terrence-low-ZADioNn1XKw-unsplash 1.png"/>
       </div>
        </div>
...
Naka, Wagle Estate, Thane West,Thane
      ...
      <div className='flight_main'>
        ...
        <div className="secondly  mt_none">
      
        <p className='fli text-start text-capitalize ms-'>nearby other mosques</p>
...
export default View_details_zayad_mosq
