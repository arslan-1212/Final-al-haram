                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-2 my-auto">
                            <div className="text-center text-lg-start">
                                ...
                                <button className="px-3 py-2 my-1" style={{ backgroundColor: '#D9D9D9', border: '1px solid #838383' }}>Seat no1 <img src={vertical_bar} alt=''></img></button>
                                {/* <button className="px-3 py-2 ms-2" style={{ backgroundColor: '#D9D9D9', border: '1px solid #838383' }}>Seat no2 <img src={vertical_bar} alt=''></img></button> */}
                        ...
                        <div className="col-lg-8" >
                            ...
                            <div className="row mt-5 g-0 text-center text-lg-start">
                                ...
                                <div className="col-lg-3 col-6 ">
                                    ...
                                    <button className="px-3 py-2" style={{ backgroundColor: '#D9D9D9', border: '1px solid #838383' }}>Seat no2 <img src={vertical_bar} alt=''></img></button>
