...
import Tab_market from '../Tab_market/Tab_market';
import Similar from '../Similar/Similar';
function View_details_market() {
  return (
    <div className=' mt-5'>
<div className="text-capitalize   text-start ms-1 ms-md-5 capstan-lef">gabel street souq</div>
...
28800 Orchard Lake Road, Suite 180 Farmington Hills, U.S.A</div> 
      ...
      <div className="row px-3 m-0">
        ...
        <div className='mt-3'>
        <Slidercor sliderlan1="gabel-street 6.png" sliderlan2="gabel-street 6.png" sliderlan3="gabel-street 6.png"/>
       </div>
        </div>
...
export default View_details_market
