      ...
      <div className="c mt-5 ">
        ...
        <div className="row ">
            <div className="col-lg-4">
                <img src="gbb.png" className='w-100 h-100'  alt="" />
            </div>
            <div className="col-lg-8">
<div className="row">
    <div className="col-lg-5 mt-2 mt-md-3">
<div className="fs-5 park-al text-start ms-2 text-uppercase">gabel street souq</div>
    </div>
...
<div className="row mt-4 ">
   ...
   <span className='mb_fs_ress'>     11:00Pm   
    ...
    <div className="col-lg-4 col-sm-12">
      <Link to="/View_details_market">  <button className="btn btn-md text-white boldify float-start naya-color float-md-end ms-2 ms-md-0 me-5 mt-3">View Detail</button></Link>
    </div>
</div>
