...
<Link to="/Explore_Malls_d">
  ...
  <img src={props.img} className="img-fluid rounded-start h-100 w-100" alt="..."/>
</Link>

</div>
<div className="col-md-8">
    <div className="card-body text-md-start ms-md-2 pb-0 text-start">
    <h5 className="card-title d-flex  align-items-center">{props.title} <span className='ms-2'><Rating name="read-only" style={{marginLeft:'10px'}} defaultValue={5} precision={5} readOnly /></span> </h5> 
    <div className="row ">
    ...
    <p className="card-text mb-1" style={{fontSize:"15px",marginTop:'15px'}}> <span className='me-2'><img src="Map Marker.png" alt="" /></span>
{props.location}</p>
  </div>
