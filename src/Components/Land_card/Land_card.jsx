...
function Land_card() {
  return (
    ...
    <div class="card shadow mb-4">
      <div class="  row g-0">
        <div class="col-lg-4">
          <img src="image 20.png" class="img-fluid rounded-start h-100 w-100" alt="..."/>
    </div>
        <div class="col-lg-8">
          <div class="card-body text-start ">
          <span><h6 class="card-title  fs-5">Classes Land Package 
    ...
    <div className="row">
      <div className="col-lg-8"></div>
           ...
           <Link to='/Land_second'><button className='btn btn-sm ucard btn-000 my-2 mb-md-0  text-white '>VIEW DETAIL</button></Link>
    ...
    <Link to='/Land_second'><button className='btn btn-00 btn-sm ucard text-white'>40 Remaining Pax </button></Link>
